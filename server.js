...
// requisição para editar um gasto existente pelo id
app.put('/api/gastos/:id', (req, res) => {
    ...
    const resultado = db.prepare('UPDATE gastos SET descricao = ?, valor = ?, data = ?, categoria_id = ? WHERE id = ?')
      .run(descricao, valor, data, categoria_id, id);
